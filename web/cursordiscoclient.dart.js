...
$$.MediaElement = {"": "Element;currentSrc=,currentTime%,playbackRate=,src}",
...
DrawableAnimation: {"": "Drawable;x>,y>,img<",
  ...
  draw$1: function(ctx) {
    ...
    t3 = this.frames;
    $.drawImageScaledFromSource$9$x(ctx, t1, (this.frameNow - 1) * $.$div$n(t2.get$width(t1), t3), 0, $.$div$n(t2.get$width(t1), t3), t2.get$height(t1), this.x, this.y, $.$div$n(t2.get$width(t1), t3), t2.get$height(t1));
  }
},

DrawableDiscoBall: {"": "DrawableAnimation;frameSpeed,frames,frameNow,msSinceChange,x,y,img,destroy",
  update$1: function(n) {
    this.x = $.$div$n($.screenWidth, 2) - $.$div$n($.get$width$x(this.img), 12) / 2;
...
DrawableFPSCounter: {"": "Drawable;_timeoflastfpscount,_frameCount,_prevInfo,previousTime,x>,y>,destroy",
  ...
  draw$1: function(ctx) {
    ...
    t1.fillText$4(ctx, $.JSNumber_methods.toString$0(this._prevInfo) + " FPS - Frames drawn since last: " + $.S(this._frameCount) + " Now Playing: " + $.S($.get$currentSrc$x($.aud)), this.x, this.y, ctx.canvas.width);
  }
},
...
loadDisco_closure2: {"": "Closure;",
  call$1: function(ev) {
    ...
    t3 = t2.get$clientX(ev);
    t2 = t2.get$clientY(ev);
    t1.x = t3;
    t1.y = t2;
  }
},
...
loadDisco_closure5: {"": "Closure;",
  call$1: function(T) {
    var t1;
    if ($.synced)
      if ($.$gt$n($.get$playbackRate$x($.aud), 0)) {
        t1 = $.get$ws();
...
WebSocketHandler: {"": "Object;ws,sIP,sPort,sPath,messageHandler",
  ...
  connect$1: function(onOpen) {
    var t1, t2;
    $.canSend = false;
    this.ws = $.WebSocket_WebSocket("ws://" + this.sIP + ":" + this.sPort + "/" + this.sPath, $);
    t1 = this.ws;
    t1.get$onMessage;
...
loadDisco: function() {
  ...
  t2 = new $._EventStream(window, $.EventStreamProvider_mousemove._eventType, false);
  t2 = new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.loadDisco_closure2(), t2._useCapture);
  t1 = t2._onData;
...
messageHandler: function(message) {
  var splitMsg, t1, cursorID, t2, t3, t4, x, y, songName, songTimeLocation;
  ...
  switch (splitMsg[0]) {
    case "NEWCONNECTION":
      ...
      if (!t1.containsKey$1(splitMsg[1])) {
        ...
        t1 = t1.$index(t1, "cursors");
        t2 = new $.DrawableCursor(0, 0, 0, null, null, null, cursorID, 4, [[0, 0], [1, -4], [0, -3], [-1, -4], [0, 0]], false);
        t3 = t2.ID;
        if (!$.get$DrawableCursor_cursors().containsKey$1(t3)) {
          t4 = $.get$DrawableCursor_cursors();
    ...
    case "MOVECURSOR":
      ...
      if (t1.containsKey$1(splitMsg[1])) {
        ...
        if (2 >= splitMsg.length)
          throw $.ioore(2);
        x = $.$mul$n(t1, $.$div$n($.Primitives_parseDouble(splitMsg[2], null), 100));
        t1 = $.screenHeight;
        if (3 >= splitMsg.length)
          throw $.ioore(3);
        y = $.$mul$n(t1, $.$div$n($.Primitives_parseDouble(splitMsg[3], null), 100));
        t1 = $.get$DrawableCursor_cursors();
        if (1 >= splitMsg.length)
          throw $.ioore(1);
        t1.$index(t1, splitMsg[1]).updatePos$2(x, y);
      }
      break;
    case "DISCONNECT":
      if (1 >= t1)
    ...
    case "CHANGESONG":
      ...
      $.set$src$x($.aud, "./assets/" + $.S(songName));
